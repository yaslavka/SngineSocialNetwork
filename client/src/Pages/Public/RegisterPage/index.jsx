...
function RegisterPage() {
  ...
  const submitRegisterPageForm = useCallback(
    (credentials) => {
      if (!isPrivacy) {
        dispatch(
          actions.signUpError({ errorPrivacy: 'YouMustAcceptPrivacyPolicy' }),
        )
      } else {
      ...
      {siteInfo && (
        <AuthPageContainer siteInfo={siteInfo}>
          ...
          <Formik
            ...
            onSubmit={submitRegisterPageForm}
          >
            {() => (
              <Form className={styles.formAth}>
                <div className={styles.flexInputs}>
                  <div
                    className={`${styles.columnInputs} ${styles.columnMaxW}`}
                  >
                ...
                <label
                  htmlFor="email"
                  className={
                    signUpError && signUpError.errorEmail
                      ? styles.labelError
                      : styles.label
                  }
                >
                  {signUpError && signUpError.errorEmail
                    ? t(signUpError.errorEmail)
                    : t('emailLabel')}
                </label>
                <Field
                  id="email"
                ...
                <label
                  htmlFor="username"
                  className={
                    signUpError && signUpError.errorUsername
                      ? styles.labelError
                      : styles.label
                  }
                >
                  {signUpError && signUpError.errorUsername
                    ? t(signUpError.errorUsername)
                    : t('usernameLabel')}
                </label>
                <Field
                  id="username"
